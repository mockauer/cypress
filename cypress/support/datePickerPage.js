//funciton muss außerhalb der Methode, damit man diese aufrufen und nutzen kann
    ...
    let dateAssert = futureMonth+' '+futureDay+", "+date.getFullYear()
        ...
        cy.get('nb-calendar-navigation').invoke('attr', 'ng-reflect-date').then( dataAttribute => {
            ...
            if (!dataAttribute.includes(futureMonth)) {
                ...
                //Calender Range hat andere CSS Klasse, darum muss man hier nochmal anpassen
                // cy.get('nb-calendar-day-picker [class="day-cell ng-star-inserted"]').contains(futureDay).click()
                //Cypress hat schöne Methode für das Kalenderproblem
                //hier geht es auf die Klasse, die die inaktiven Daten ausschließt ".not"
